...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      let(:game_mid) { described_class.new(5, '0') }
      # remove the 'x' before running this test
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        incorrect_values1 = '1_000'
        incorrect_values2 = '-1'
        valid_input = '3'
        allow(game_loop).to receive(:player_input).and_return(incorrect_values1, incorrect_values2, valid_input)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      subject(:game_five) { described_class.new(4, '4', 100) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        congrats_phrase = "That was hard. It took you 100 guesses!\n"
